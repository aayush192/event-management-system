...
export const filterEventSchema = z.object({
    ...
    category: z.preprocess((val) => (typeof val === "string" ? val.toUpperCase() : val), categorySchema.optional()),
...
export const updateEventSchema = createEventSchema
    .partial()
    .refine((data) => data.category || !data.description || !data.eventdate || !data.name, {
